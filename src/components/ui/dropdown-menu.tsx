 ...
 * 
 * A comprehensive dropdown menu built with Radix UI primitives.
 * Used for user menus, action menus, and context menus throughout
 * the application, especially in the dashboard sidebar.
 * 
 * Features:
...
// Re-export root components from Radix
 ...
 * Includes a chevron indicator pointing right.
 */
 ...
 * Positioned to the side of the parent menu.
 */
 ...
 * Supports keyboard focus and optional left padding.
 */
